  ...
  return (
    <div className="p-6">
      ...
      <div className="flex justify-center mb-5 ">
        <Link to="/filters">
          <button className=" text-white  bg-black focus:outline-none text-sm px-5 py-3 lg:py-4 text-center flex space-x-2 items-center  rounded-xl ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-2">
        ...
        <section className="bg-teal-100 p-6 rounded-lg shadow-md">
          ...
          <div className="bg-teal-200 p-4 rounded-md shadow-md mb-4">
            ...
            <p className="text-gray-700">
              Scheduled maintenance will occur every Saturday from 2 PM to 4 PM.
            </p>
          </div>
        </section>
        ...
        <section className="bg-orange-100 p-6 rounded-lg shadow-md">
          ...
          <p className="mb-4 text-gray-700">
            Join our community forum to connect with other users, ask questions,
            and share tips.
          </p>
          <p className="mb-4 text-gray-700">
            Engage in discussions about the latest trends and best practices in
            our industry.
          </p>
          <p className="mb-4 text-gray-700">
          ...
          <p className="mb-4 text-gray-700">
            Share your own experiences and help others by providing solutions to
            common issues.
          </p>
        </section>
