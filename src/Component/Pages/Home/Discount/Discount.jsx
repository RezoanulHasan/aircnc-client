...
const Discount = () => {
  const calculateTimeLeft = () => {
    const discountEndDate = new Date("2024-01-01"); // Set the end date of the discount
    ...
    <Container>
      <div className="flex flex-col items-center justify-center pt-16  ">
        <h3 className="text-3xl text-center mb-6">
          ...
          Discount For All Accommodation  to , <span className="text-red-400  font-semibold">JAN 2024.</span>
        </h3>
